...
public class DDActionBar extends BaseActionBar {
    ...
    public DDActionBar(Context context, @Nullable AttributeSet attrs) {
        ...
        LinearLayout.LayoutParams leftIconParams = (LinearLayout.LayoutParams) mLeftImg.getLayoutParams();
        ...
        LinearLayout.LayoutParams rightIconParams = (LinearLayout.LayoutParams) mRightImg.getLayoutParams();
